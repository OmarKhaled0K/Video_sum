...
save_dir = Path(r'E:\Artificial_Intelligence\Video Summarization\Datasets\tvsum\weights')
score_dir = Path(r"E:\Artificial_Intelligence\Video Summarization\Datasets\tvsum\score")
